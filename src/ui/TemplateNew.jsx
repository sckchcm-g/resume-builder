    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.container}>
          ...
          <Text style={styles.text}>Experienced software developer with a passion for creating efficient, scalable, and maintainable web applications.</Text>
          <Text style={styles.sectionTitle}>Experience</Text>
          <Text style={styles.subtitle}>Software Developer - XYZ Inc.</Text>
          <Text style={styles.date}>June 2018 - Present</Text>
          <Text style={styles.text}>- Developed and maintained web applications using React.js.</Text>
          <Text style={styles.text}>- Collaborated with cross-functional teams to deliver high-quality software products.</Text>
          <Text style={styles.text}>- Implemented responsive design principles to ensure optimal user experience across devices.</Text>
