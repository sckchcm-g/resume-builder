...
function TemplateD2() {
  ...
  return (
    <div
      className="w-[210mm] h-[297mm] bg-[white] border m-[10mm] border-solid border-[black] mt-[-150px] "
      ...
      <div>
        ...
        <div className="flex flex-col absolute -translate-x-2/4 -translate-y-2/4 left-[22%] top-[52%]">
          <div className="flex flex-row justify-start items-center">
            ...
            <p className="mt-[10px]">
              - Worked in Capgimini for 2 years, <br /> Plano, Human Resources
              Manager
            </p>
          </div>
          <div className="flex flex-row justify-start items-center">
        ...
        <div className="bg-[rgb(244,245,244)] w-[65%] h-[297mm]">
          <div className="absolute -translate-x-2/4 -translate-y-2/4 text-lg font-[bold] w-[210px] text-[rgb(90,80,154)] text-justify w-60 left-[82.5%] top-[52%]">
            <p>
              ...
              Organized new hiretraining initiatives as well asongoing training
              to adhere toworkplace safety standards.Worked with OSHA to
              ensurethat all safety regulations arefollowed.
            </p>
          </div>
