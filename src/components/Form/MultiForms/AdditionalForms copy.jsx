...
import {LanguageForm,CustomForm,SkillsForm,CertificatesForm,ProjectsForm} from './AdditionalForms/index.js';
...
const FormCards = ({TabIcons,TabHead,setCurrForm,FormNum})=>{
  return(
    ...
    <div onClick={()=>setCurrForm(FormNum)}  className=" cursor-pointer sm:p-1 p-2 flex flex-col justify-center align-middle gap-2 border border-purple-600  h-20 md:w-24 md:h-24 md:min-w-14  bg-purple-100 rounded-lg">
      <div>
...
const AccorComponent = () => {
  ...
  return (
    ...
    <div className="p-2 md:p-6 mt-[20px] w-[370px]  md:w-auto  md:max-w-[480px] h-[100%] xl:h-[65%]  border-[#9333ea] m-0  border-2 shadow-[#9333ea] shadow-md">
      ...
      <div className="my-2">
        ...
        <FormCards FormNum={4} setCurrForm={setCurrForm}  TabIcons={MdDeveloperMode} TabHead={"Custom Section"}/> 
      </div>
