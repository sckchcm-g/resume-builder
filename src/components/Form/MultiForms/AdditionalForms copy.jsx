...
const FormCards = ({ TabIcons, TabHead, setCurrForm, FormNum }) => {
  return (
    ...
    <div
      ...
      className=" cursor-pointer sm:p-1 p-2 flex flex-col justify-center align-middle gap-2 border border-purple-600  h-20 md:w-24 md:h-24 md:min-w-14  bg-purple-100 rounded-lg"
    >
      <div>
