...
import{PersonalDetail,PersonalEdu,PersonalExp,PersonalSkills} from './MultiForms/index.js'

const FormCtn =({num})=>{
  return(
  <div>
    {/* Used COndtional Rendering to Render Different Forms */}
    {num===0?<PersonalDetail/>:num===1?<PersonalEdu/>:num===2?<PersonalExp/>:<PersonalSkills/>}
  </div>
  )
}
...
const FormSection = () =>{
  ...
  return(
    <div className="border border-blue-500 rounded-lg border-teal-300 w-11/12 m-auto md:w-7/12 lg:w-6/12 ">
