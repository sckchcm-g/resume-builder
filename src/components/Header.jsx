  ...
  return (
    <div className='header-wrapper pt-5 '>
      <header className='flex justify-between '>
        ...
        <div className='mt-3'><button className='logo p-4  bg-[#de8535] rounded-full'><span className='text-white text-4xl  font-serif'>C</span><span className='text-white text-4xl font-serif'>C</span></button></div>
        <div>
            <div className="firstName text-[#de8535] font-serif text-4xl">Chris</div>
            <div className="lastName text-[#de8535] font-serif text-4xl">Candidate</div>
            <div className="job-title text-md font-serif">Human Resource Manager</div>
        </div>
        </div>
